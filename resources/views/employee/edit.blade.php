...
<form action="{{  URL::to('employee/update') }}" method="POST" enctype="multipart/form-data" id="employee">
    @csrf
     ...
     <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text"
                           ...
                           value="@if(!empty($user->Emp_ID)){{ $user->Emp_ID }}@endif"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <select class="form-control" id="department" name="department">
                    ...
                    <option value="Software" {{ (@$user->department == 'Software' ) ? 'selected' : '' }}>Software</option>
